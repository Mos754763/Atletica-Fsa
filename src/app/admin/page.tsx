  ...
  if (profile.role === "cozinha") {
    return (
      <main className="erp-dashboard">
        ...
        <MotionReveal className="erp-dashboard__motion" delay={0.08} eager><section className="erp-dashboard__section"><div className="erp-dashboard__section-head"><div><p className="eyebrow eyebrow--blue">ATENDIMENTO</p><h2>Seu fluxo de trabalho.</h2></div><p>Os pedidos recebidos aparecem ao vivo no ODS.</p></div><div className="erp-dashboard__shortcuts"><Link href="/ods" className="erp-dashboard__shortcut"><ListChecks size={21} /><h3>ODS de pedidos</h3><p>Organize a produção, atualize os status e sinalize pedidos prontos para retirada.</p><span>Abrir operação <ArrowRight size={14} /></span></Link></div></section></MotionReveal>
      </main>
    );
  }
