...
import { inviteMember, updateMemberInterestStatus, updateMemberRole } from "./actions";
...
export default async function MembersAdminPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  const [{ data: profiles }, { data: interestApplications }, { data: abuseSummary }, { data: abuseDailyMetrics }] = await Promise.all([
