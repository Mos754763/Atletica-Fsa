...
const previewCatalog: CatalogProduct[] = [
  { id: "preview-camiseta", name: "Camiseta Oficial FSA", slug: "camiseta-oficial-fsa", description: "Camiseta da torcida para qualquer rolê FSA.", sku: "FSA-CAM-001", category: { id: "vestuario", name: "Vestuário", slug: "vestuario" }, priceCents: 6990, stockQuantity: 12, isFeatured: true, imageUrl: fsaStoreAssets.camiseta },
  { id: "preview-moletom", name: "Moletom Titular FSA", slug: "moletom-titular-fsa", description: "Moletom azul para representar em todos os eventos.", sku: "FSA-MOL-001", category: { id: "vestuario", name: "Vestuário", slug: "vestuario" }, priceCents: 14990, stockQuantity: 7, isFeatured: true, imageUrl: fsaStoreAssets.moletom },
  { id: "preview-copo", name: "Copo FSA", slug: "copo-fsa", description: "Copo reutilizável da atlética.", sku: "FSA-COP-001", category: { id: "acessorios", name: "Acessórios", slug: "acessorios" }, priceCents: 2490, stockQuantity: 20, isFeatured: true, imageUrl: fsaStoreAssets.copo },
  { id: "preview-chaveiro", name: "Chaveiro Coelho FSA", slug: "chaveiro-coelho-fsa", description: "Mascote FSA para levar junto.", sku: "FSA-CHA-001", category: { id: "acessorios", name: "Acessórios", slug: "acessorios" }, priceCents: 1490, stockQuantity: 22, isFeatured: false, imageUrl: fsaStoreAssets.chaveiro },
