...
- [ ] Diagnosticar e corrigir a causa comprovada do estado UNSTABLE da PR #2 no GitHub
- [ ] Atualizar as actions do CI para runtime Node.js 24 e remover o aviso de depreciação sem alterar a versão da aplicação
