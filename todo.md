...
- [ ] Renomear tecnicamente o papel `cozinha` para `backoffice`, com migração compatível de enum, RLS, atribuições existentes, interface e testes em homologação e Production
