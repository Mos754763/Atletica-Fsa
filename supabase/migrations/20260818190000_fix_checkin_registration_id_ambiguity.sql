-- A função retorna uma coluna chamada registration_id. Em PL/pgSQL, a referência
-- sem qualificação no SELECT de event_tickets ficava ambígua com esse parâmetro OUT.
